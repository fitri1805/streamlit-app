...
def run():
    ...
    if user_role != "admin":
        ...
        # For admin, add avatar name as a separate column
    ...
    with tab1:
        ...
        if monthly_final_df.empty:
            ...
            st.dataframe(monthly_final_df, use_container_width=True)
            
            # Excel conversion for monthly_final
            ...
            # Download buttons for monthly_final
    ...
    with tab2:  
        ...
        if monthly_rankings_df.empty:
            ...
            # For admin, show both lab and avatar name
            if user_role == "admin":
                # Reorder columns to show avatar_name next to lab
            ...
            st.dataframe(monthly_rankings_df, use_container_width=True)
            
            # Excel conversion for monthly_rankings
